...
int main(int argc, char **argv) {
    ...
    double cobaltBlue[] =       {  0,  80, 181, 1.00, 0.56,    0, 0.29};
    double discordGrey[] =      { 49,  51,  56, 0.13, 0.09,    0, 0.78};
    double nebraskaScarlet[] =  {188,   0,   0,    0, 1.00, 1.00, 0.26};
    double nebraskaCream[] =    {253, 241, 217,    0, 0.05, 0.14, 0.01};
    ...
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test_prestate(testBidirectionalValues, &cobaltBlue),
            cmocka_unit_test_prestate(testBidirectionalValues, &discordGrey),
            cmocka_unit_test_prestate(testBidirectionalValues, &nebraskaScarlet),
            cmocka_unit_test_prestate(testBidirectionalValues, &nebraskaCream)
